...
<div class="layui-container">
	<div class="login-show">
		...
		<div class="login-content">
			<form class="layui-form" action="/main/login" method="post" id="regForm" enctype="multipart/form-data">
			  ...
			  <div class="layui-form-item" style="margin-top: 40px;">
			  	 <div class="layui-inline">
				    <div class="layui-input-block" style="margin-left: 10px; width: 100px;">
				       <button class="layui-btn" style="background-color: #009ACD" lay-submit="" lay-filter="logSubmit">立即登陆</button>
				    </div>
				</div>
				<div class="layui-inline">
