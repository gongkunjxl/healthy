			...
			<form class="layui-form" action="/main/register" method="post" id="regForm" enctype="multipart/form-data">
			  <div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			     	 <input type="text" name="username" lay-verify="required" autocomplete="off" placeholder="请输入用户昵称" class="layui-input">
			    </div>
			  </div>
			  ...
			  <div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			     	 <input type="tel" name="phone" id="phoneNum" lay-verify="required|phone" autocomplete="off" placeholder="请输入手机号" class="layui-input">
			    </div>
			  </div>
			  <div class="layui-form-item">
			  	 <div class="layui-inline" style="width: 200px;margin-right: 0;">
				    ...
				    <div class="layui-input-block" style="width: 120px;">
				       	<input type="text" name="number" id="veryCode" lay-verify="required|number" autocomplete="off" class="layui-input">
				    </div>
				</div>
				 <div class="layui-inline" style="width: 120px;">
				    <div class="layui-input-block" style="width: 100px; margin-left: 0;">
				       	 <label class="layui-btn" value="获取验证码" onclick="getCode(this)" style="background-color: #009ACD;padding: 0 10px">获取验证码</label>
				    </div>
				</div>
			</div>
			  <div class="layui-form-item">
			  ...
			  <div class="layui-form-item">
			    ...
			    <div class="layui-input-block">
			     	 <input type="password" name="password" id="veryPassword"  lay-verify="pass|required" autocomplete="off" placeholder="请确认密码 至少6个字符" class="layui-input">
			    </div>
			  </div>
			  ...
			  <div class="layui-form-item" style="margin-top: 40px;">
			  	<div class="layui-inline">
				    <div class="layui-input-block" style="margin-left: 10px; width: 100px;">
				       <button class="layui-btn" style="background-color: #009ACD" lay-submit="" lay-filter="subReg">立即注册</button>
				    </div>
				</div>
				<div class="layui-inline">
			      <div class="layui-input-inline" style="width: 230px;">
			        <a  href="/main/login" class="layui-btn layui-btn-primary" style="float: right;  border:0">已有账号登录?</a>
			      </div>
			    </div>
			  </div>
