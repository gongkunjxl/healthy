...
<div class="layui-container">
    <div class="layui-row ">
		...
		<div class="layui-col-md6" style="height:auto; overflow:hidden;">
		  	<!-- 视频 -->
			<div>
				<p style="text-align: center;font-size: 23px;color:#1792CD;"><b>健康生活方式</b></p>
			</div>
			...
			<div>
		    	...
		    	<div style="width: 100%;margin-top: 3px;">
					<div class="quick-detail-item" onmouseover="javascript:addHeight(this);" onmouseleave="javascript:decreaseHeight(this);" onclick="">
						<div class="clarity">
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">情绪管理</p>
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">情绪管理介绍</p>
						</div>
					</div>
					<div class="quick-detail-item" onmouseover="javascript:addHeight(this);" onmouseleave="javascript:decreaseHeight(this);" onclick="">
						<div class="clarity">
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">智慧选择</p>
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">智慧选择介绍</p>
						</div>
					</div>
					...
					<div class="quick-detail-item" onmouseover="javascript:addHeight(this);" onmouseleave="javascript:decreaseHeight(this);" onclick="" style="margin-top: 20px;">
						<div class="clarity">
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">吃动平衡</p>
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">吃动平衡介绍</p>
						</div>
					</div>

					<div class="quick-detail-item" onmouseover="javascript:addHeight(this);" onmouseleave="javascript:decreaseHeight(this);" onclick="" style="margin-top: 20px;">
						<div class="clarity">
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">膳食平衡</p>
							<p style="font-size: 16px;text-align: center; height: 100%;line-height:40px">膳食平衡介绍</p>
						</div>
					</div>
		    	</div>
			</div>	
