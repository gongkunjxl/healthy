    ...
    **/
    ...
    public function addNewPPT()
    {
        ...
        if ($_FILES["file"]["error"] > 0) {
            ...
            $path = "ppt/".$file_name;
            move_uploaded_file($_FILES["file"]["tmp_name"],$path);
            $pptUrl = "/Users/liuzuobin/Desktop/好分数产品宣讲会 - 学校端.pptx";
            $pictureUrl = "/Users/liuzuobin/Desktop/pptDir";
            $param = "pptUrl=".$pptUrl."&pictureUrl=".$pictureUrl."&id=".1;
            request_post($api_url,$param);
            $return['url'] = $path;
            $return['status'] = 200;
        } 
        $url = $postinfo['url'];
