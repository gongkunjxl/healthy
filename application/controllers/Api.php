...
class Api extends MY_Controller {
    ...
    **/
    ...
    public function pptList($page=1)
    {
        ...
        //audio
        $orderby = "create_time";
        $select_field="id,name,author,description,page_count,pic_url,source_url,themeId,type,language,province,reader_num,date_format(create_time,'%Y-%m-%d') as create_time";
