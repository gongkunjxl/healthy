...
class Main extends MY_Controller {
	...
	*/
	public function searchPPT($theme,$type,$media,$language,$province,$search)
	{
    	...
    	//audio
    	$orderby = "is_top,create_time";
    	$select_field="id,name,author,description,source_url,pic_url,page_count,themeId,type,language,province,reader_num,date_format(create_time,'%Y-%m-%d') as create_time";
	...
	*/
	...
	public function powerpoint($page=1)
	{
    	...
    	//audio
    	$orderby = "is_top,create_time";
    	$select_field="id,name,author,description,source_url,page_count,pic_url,themeId,type,language,province,reader_num,date_format(create_time,'%Y-%m-%d') as create_time";
        $ppt_data=$this->Common->get_limit_order( $this->ppt_table,$where,$start,$this->per_page,$orderby,$order_type,$select_field);
        $tmp_data=$this->Common->get_limit_order( $this->ppt_table,$where,$start,'',$orderby,$order_type,$select_field,$like);
