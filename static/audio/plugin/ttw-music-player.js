        ...
        playlistMgr = function() {
            ...
            markup = {
                listItem:'<li class="track">' +
                            ...
                            '<a href="#" class="reader not-active" target="_blank"></a>' +
                        '</li>',
...
addMoreItem();
            ...
            function addMoreItem(){
                var myPlaylist1 = 

                            {
                                ...
                                description:'简单介绍000000000'
                            }
                        ;
                
                myPlaylist.push(myPlaylist1);
                var $ratings = $();
                ...
                for (var j = myPlaylist.length - 1; j < myPlaylist.length; j++) {
                    var $track = $(markup.listItem);
                ...
                $tracks.slice(myPlaylist.length - 1, myPlaylist.length).each(function() {
                    remainingHeight += $(this).outerHeight();
                });
            ...
            function setreaderLink($track, index) {
                if (!isUndefined(myPlaylist[index].reader)) {
                    $track.find(cssSelector.reader).removeClass(attr(cssSelector.readerNotActive)).attr('href', myPlaylist[index].reader).html(readerText(index));
                }
            }

            function readerText(index) {
                return options.readerText + ' ' + (!isUndefined(myPlaylist[index].num) ? myPlaylist[index].num : '');
            }
        ...
        interfaceMgr = function() {
            ...
            function setDescription() {
                if (isUndefined(myPlaylist[current].description))
                    $self.find(cssSelector.description).parent(cssSelector.artistOuter).animate({opacity:0}, 'fast');
                else {
